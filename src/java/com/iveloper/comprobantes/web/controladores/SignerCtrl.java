 ...
 * @author Alex
 */
@WebServlet(name = "SignerCtrl", urlPatterns = {"/SignerCtrl"})
public class SignerCtrl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (op.equalsIgnoreCase("configurar")) {
            ...
            configurarSigner(request, response);
        }
    }

    public void configurarSigner(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            output = new FileOutputStream("C:\\Users\\Alex\\Documents\\NetBeansProjects\\ComprobantesElectronicosWebDemo\\web\\WEB-INF\\certificado.properties");
